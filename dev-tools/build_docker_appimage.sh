...
docker run --rm \
    ...
    appimage-builder /bin/bash -c "
        ...
        cp ./AppDir/usr/share/pixmaps/cppcrosshair.png ./AppDir/cppcrosshair.png && \

        export VERSION=\"1.0.0\"
        
        linuxdeployqt ./AppDir/usr/share/applications/cppcrosshair.desktop \
            -unsupported-allow-new-glibc \
            -qmake=/usr/lib/qt6/bin/qmake

        appimagetool ./AppDir ./cppcrosshair-toolkit-x86_64.AppImage
    "
